...
'Dohledat a přidat místo': 'Dohledat a přidat místo',
'dohledat a přidat místo': 'dohledat a přidat místo',
...
'Ještě nemáte zvoleno žádné místo zájmu.': 'Ještě nemáte zvoleno žádné místo zájmu.',
'Ještě nemáte zvoleno žádné místo zájmu. Můžete si nějaké přidat.': 'Ještě nemáte zvoleno žádné místo zájmu. Můžete si nějaké přidat.',
'JSON': 'JSON',
...
'Místo': 'Místo',
'Můžete si nějaké přidat.': 'Můžete si nějaké přidat.',
'na hlavní stranu': 'na hlavní stranu',
'Name': 'Jméno',
'nastavení': 'nastavení',
'Ne': 'Ne',
...
'odhlásit uživatele %s': 'odhlásit uživatele %s',
'odstranit': 'odstranit',
'Odstranit místo': 'Odstranit místo',
...
'Opravdu odstranit místo zájmu?': 'Opravdu odstranit místo zájmu?',
...
'Prosím vyberte některou možnost %s%s.': 'Prosím vyberte některou možnost %s%s.',
'Prosím vyberte některou možnost 12001.': 'Prosím vyberte některou možnost 12001.',
'Prosím vyberte některou možnost 13000.': 'Prosím vyberte některou možnost 13000.',
'Prosím vyberte některou možnost.': 'Prosím vyberte některou možnost.',
'Prosím zadejte datum ve formátu %d.%m.%Y.': 'Prosím zadejte datum ve formátu %d.%m.%Y.',
'Prosím zadejte datum ve formátu %s.': 'Prosím zadejte datum ve formátu %s.',
'Prosím zadejte datum, např. %s.': 'Prosím zadejte datum, např. %s.',
'Prosím zadejte datum, např. 22.10.2017.': 'Prosím zadejte datum, např. 22.10.2017.',
'Prosím zadejte datum.': 'Prosím zadejte datum.',
'Prosím zadejte tento údaj.': 'Prosím zadejte tento údaj.',
'Prosím zadejte číslo od %s do %s.': 'Prosím zadejte číslo od %s do %s.',
'Prosím zadejte.': 'Prosím zadejte.',
'Python': 'Python',
'přidat (další) místo': 'přidat (další) místo',
'přidat místo zájmu': 'přidat místo zájmu',
'Přidat místo:': 'Přidat místo:',
...
'variables': 'proměnné',
'Vaše místa zájmu:': 'Vaše místa zájmu:',
